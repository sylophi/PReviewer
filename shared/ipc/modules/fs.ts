...
export const fsContract = {
  listDirectory: invoke("fs:listDirectory", ListDirectoryPayloadSchema, DirectoryListingSchema),
  isGitRepo: invoke("fs:isGitRepo", IsGitRepoPayloadSchema, z.boolean()),
  scanForGitRepos: invoke("fs:scanForGitRepos", ScanForGitReposPayloadSchema, z.array(z.string())),
} as const;
