...
export const reposContract = {
  ...
  branches: invoke("repos:branches", RepoBranchesPayloadSchema, RepoBranchesSchema),
  recentCommits: invoke(
    "repos:recentCommits",
    RecentCommitsPayloadSchema,
    z.array(RecentCommitSchema),
  ),
  worktrees: invoke("repos:worktrees", WorktreesPayloadSchema, z.array(WorktreeSchema)),
} as const;
